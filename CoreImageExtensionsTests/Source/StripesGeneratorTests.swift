...
class StripesGeneratorTests: XCTestCase {

	func testDataStructure() {
		let dataStructure = StripesGenerator(width: 80, color1: CIColor(red: 0.0, green: 0.0, blue: 0.0, alpha: 1.0), color0: CIColor(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0), sharpness: 1, center: CIVector(values: [150.0, 150.0], count: 2))
		XCTAssertNotNil(dataStructure.filter())

		let compareFilter = CIFilter(name: "CIStripesGenerator")
