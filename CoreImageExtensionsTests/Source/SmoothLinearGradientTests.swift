...
class SmoothLinearGradientTests: XCTestCase {

	func testDataStructure() {
		let dataStructure = SmoothLinearGradient(point1: CIVector(values: [200.0, 200.0], count: 2), color1: CIColor(red: 0.0, green: 0.0, blue: 0.0, alpha: 1.0), color0: CIColor(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0), point0: CIVector(values: [0.0, 0.0], count: 2))
		XCTAssertNotNil(dataStructure.filter())

		let compareFilter = CIFilter(name: "CISmoothLinearGradient")
