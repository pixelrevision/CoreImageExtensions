...
class PerspectiveTileTests: XCTestCase {

	func testDataStructure() {
		let dataStructure = PerspectiveTile(topRight: CIVector(values: [646.0, 507.0], count: 2), image: CIImage(name: "sample_image_1", classForBundle: self.dynamicType)!, bottomLeft: CIVector(values: [155.0, 153.0], count: 2), topLeft: CIVector(values: [118.0, 484.0], count: 2), bottomRight: CIVector(values: [548.0, 140.0], count: 2))
		XCTAssertNotNil(dataStructure.filter())

		let compareFilter = CIFilter(name: "CIPerspectiveTile")
	...
	func testImagefilter() {
		let newImage = CIImage(name: "sample_image_1", classForBundle: self.dynamicType)?.perspectiveTileFilter(CIVector(values: [646.0, 507.0], count: 2), bottomLeft: CIVector(values: [155.0, 153.0], count: 2), topLeft: CIVector(values: [118.0, 484.0], count: 2), bottomRight: CIVector(values: [548.0, 140.0], count: 2))
