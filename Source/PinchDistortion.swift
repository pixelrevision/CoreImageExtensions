...
extension CIImage {
	...
	public func pinchDistortionFilter(center: CIVector = CIVector(values: [150.0, 150.0], count: 2), scale: NSNumber = 0.5, radius: NSNumber = 300) -> CIImage? {
		guard let filter = CIFilter(name: "CIPinchDistortion") else { return nil }
